...
static PyGetSetDef pylv_table_ext_t_getset[] = {
    ...
    {"col_w", (getter) struct_get_struct, (setter) struct_set_struct, "lv_coord_t6 col_w", & ((struct_closure_t){ &Blob_Type, offsetof(lv_table_ext_t, col_w), sizeof(((lv_table_ext_t *)0)->col_w)})},
...
static PyMethodDef pylv_list_methods[] = {
    ...
    {"add_btn", (PyCFunction) pylv_list_add_btn, METH_VARARGS | METH_KEYWORDS, ""},
...
PyInit_lvgl(void) {
    ...
    PyModule_AddObject(module, "BLEND_MODE", build_constclass('d', "BLEND_MODE", "NORMAL", LV_BLEND_MODE_NORMAL, NULL));
   ...
   PyModule_AddObject(module, "anim_path_def", pystruct_from_c(&pylv_anim_path_t_Type, &lv_anim_path_def, sizeof(lv_anim_path_t), 0));
    ...
    typesdict = Py_BuildValue("{sOsOsOsOsOsOsOsOsOsOsOsOsOsOsOsOsOsOsOsO}",
